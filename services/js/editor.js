				...
				class:"row-fluid"
					...
					id:"tblForm"+idExtn 
						...
						class:"row" 
							...
							}).append($('<label/>',{ for:"tblRows"+idExtn,	text:"Ligne"}
							)).append($('<input/>',{
								id:"tblRows"+idExtn,
								type:"text",
								class:"form-control form-control-width",
								value:2
							})).append($('<label/>',{ for:"tblColumns"+idExtn,	text:"Colunne"}
							)).append($('<input/>',{
							...
							class:"col-xs-12 col-sm-6 col-md-6 col-lg-6"
								...
								).append($('<option/>',{ text:"Position", value:""}
								)).append($('<option/>',{ text:"Gauche", value:"left"}
								)).append($('<option/>',{ text:"Centre", value:"center"}
								)).append($('<option/>',{ text:"Droit",	value:"right"}))
							).append($('<label/>',{	for:"tblBorder"+idExtn, text:"Epaisseur"}
							)).append($('<input/>',{ 
								id:"tblBorder"+idExtn,
								type:"text",
								class:"form-control form-control-width",
								value:1
							})).append($('<label/>',{ for:"tblCellspacing"+idExtn,	text:"Espace intérieur"}
							)).append($('<input/>',{
								id:"tblCellspacing"+idExtn,
								type:"text", 
								class:"form-control form-control-width",
								value:1
							})).append($('<label/>',{ for:"tblCellpadding"+idExtn,	text:"Espace extérieur"}
							)).append($('<input/>',{
								            	...
								            	class:"modal-dialog"
							            			...
							            			class:"modal-content"
									            		...
									            		class:"modal-footer"
								                			...
								                			type:"button",
								                			class:"btn btn-success",
								               				}).html('Valider').mousedown(function(e){
								                			e.preventDefault();
