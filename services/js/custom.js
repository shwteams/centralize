	...
	function(e)
	{
		...
		function n(){
			e(".sidebar").slimscroll({
				color:"rgba(0,0,0,0.5)",height:e(window).height()-e("header").height()+"px"
			})
		}
		...
		e(".dropdown").on("show.bs.dropdown",function(){e(this).find(".dropdown-menu").addClass("animated flipInY")});
		e(".dropdown").on("hide.bs.dropdown",function(){e(this).find(".dropdown-menu").removeClass("animated flipInY")});
		e("[data-toggle='tooltip']").tooltip();
		e(".navbar .dropdown-menu ul")
			.slimscroll({alwaysVisible:false,size:"3px",height:"210px"})
			.css("width","100%");
		...
		e(".remove-box").click(function(){var t=e(this).parents(".box").first();t.slideUp()});
		e(".wrapper").resize(function(){t();n()});
		e.fn.sub=function(){
			return this.each(function(){
				...
				t.click(function(e){
					...
					if(r){
						...
						$(".sub-menu").slideUp();
						$("a .fa-angle-down").removeClass("fa-angle-down").addClass("fa-angle-right");
