...
//        }
     ...
     * @param $str_FILE_NAME name of file
     * @param $directory_name directory name
     * @return array name of generated file and code statut
     */
    public static function generatecsv($datas, $str_FILE_NAME, $directory_name){
        $contenu = "";
        $code_statut = 0;
