...
if (isset($_GET["task"])) {
    ...
    addSinistre( $db, $str_NUMERO_SINISTRE, $str_CONTRAT_ID, $dt_SURVENANCE, $dt_TRAITEMENT, $mt_EVAL, $mt_PROVISION);
}
else if (isset($_POST['editSinister'])) {
    $str_CONTRAT_ID = htmlentities(trim($_POST['str_CONTRAT_ID']));
    $dt_SURVENANCE = htmlentities(trim($_POST['dt_SURVENANCE']));
    $dt_TRAITEMENT = htmlentities(trim($_POST['dt_TRAITEMENT']));
    $mt_EVAL = htmlentities(trim($_POST['mt_EVAL']));
    ...
    editeSinistre($str_SINISTER_ID, $str_NUMERO_SINISTRE, $str_CONTRAT_ID, $dt_SURVENANCE, $dt_TRAITEMENT, $mt_EVAL, $mt_PROVISION, $db);
}
    ...
    editingSinister($str_SINISTER_ID, $str_NUMERO_SINISTRE, $str_CONTRAT_ID, $mt_EVAL, $mt_CUMULE_PAYE, $mt_PROVISION, $int_BONI, $int_MALI, $str_OBSERVATION, $str_AUTRE_OBSERVATION_ID, $str_ETAT_ID, $mt_BONI_POTENTIEL, $db);
}