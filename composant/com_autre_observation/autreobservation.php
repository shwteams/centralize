...
class AutreObservation {

    static function showAutherObservation() {
        ?>
        <script src="composant/com_autre_observation/autreobservation.js"></script>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 text-right">
                    <ol class="breadcrumb">
                        ...
                        <li>Tableau de bord</li> <li>Configuration</li>  <li>Observation</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" id="str_LIBELLE" name="str_LIBELLE" placeholder="Observation" type="text" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" id="str_LIBELLE_EDIT" name="str_LIBELLE_EDIT" placeholder="Observation" type="text" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <input type="hidden" name="str_AUTRE_OBSERVATION_ID" id="str_AUTRE_OBSERVATION_ID" />
