...
class Reinsurer {
    static function showAllReinsurer() {
        ?>
        <script src="composant/com_reinsurer/reinsurer.js"></script>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 text-right">
                    <ol class="breadcrumb">
                        ...
                        <li>Tableau de bord</li> <li>Configuration</li>  <li>Réassureur</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" id="str_NOM" name="str_NOM" placeholder="Réassureur" type="text" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" id="str_LIBELLE_EDIT" name="str_LIBELLE_EDIT" placeholder="Réassureur" type="text" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <input type="hidden" name="str_REINSURER_ID" id="str_REINSURER_ID" />
