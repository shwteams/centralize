            ...
            <div class="row">
                ...
                <div class="col-sm-6 text-right">
                    <ol class="breadcrumb">
                        ...
                        <li>Tableau de bord</li>  <li>Acquisitions</li> <li>Clients</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="str_PARTNER_ID" class="col-sm-4 control-label">Type <span class="require">*</span> :</label>
                                    <div class="col-sm-8">
                                        <select name="str_PARTNER_ID" id="str_PARTNER_ID" style="width: 100%">
                                            <option value=""></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control searchCustomer" id="str_NOM" name="str_NOM" placeholder="Client" type="text" required="">
                                        <div class="customerList"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog ">
                ...
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" role="form" id="edit_key_form">
                        <div class="modal-body">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="str_PARTNER_ID" class="col-sm-4 control-label">Type <span class="require">*</span> :</label>
                                    <div class="col-sm-8">
                                        <select name="str_PARTNER_EDIT_ID" id="str_PARTNER_EDIT_ID" style="width: 100%">
                                            <option value=""></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control searchCustomer" id="str_LIBELLE_EDIT" name="str_LIBELLE_EDIT" placeholder="Client" type="text" required="">
                                        <div class="customerList"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            <input type="hidden" name="str_CUSTOMER_ID" id="str_CUSTOMER_ID" />
