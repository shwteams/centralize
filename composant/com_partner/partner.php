...
class Partner {
    ...
    static function showAllPartner() {
        ?>
        <script src="composant/com_partner/partner.js"></script>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 text-right">
                    <ol class="breadcrumb">
                        ...
                        <li>Tableau de bord</li> <li>Acquisition</li>  <li>Partenaire</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" id="str_LIBELLE" name="str_LIBELLE" placeholder="Partenaire" type="text" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" id="str_LIBELLE_EDIT" name="str_LIBELLE_EDIT" placeholder="Partenaire" type="text" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <input type="hidden" name="str_PARTENAIRE_ID" id="str_PARTENAIRE_ID" />
