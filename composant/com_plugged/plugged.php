...
class Plugged {
    ...
    static function showAllPlugged() {
        ?>
        <script src="composant/com_plugged/plugged.js"></script>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 text-right">
                    <ol class="breadcrumb">
                        ...
                        <li>Tableau de bord</li> <li>Acquisition</li>  <li>Branche</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog ">
                ...
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" role="form" id="edit_key_form">
                        ...
                        <div class="modal-footer">
                            <input type="hidden" name="str_PLUGGED_ID" id="str_PLUGGED_ID" />
